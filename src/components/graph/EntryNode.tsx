...
export function EntryNode({ data, selected }: NodeProps<EntryNodeData>) {
  ...
  return (
    ...
    >
      <Handle type="target" position={isLR ? Position.Left : Position.Top} className="!bg-gray-600 !border-gray-500" />
      ...
      <Handle type="source" position={isLR ? Position.Right : Position.Bottom} className="!bg-gray-600 !border-gray-500" />
    </div>
  )
}
